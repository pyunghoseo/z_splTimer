...
# WAV 파일들이 위치한 디렉토리 경로를 설정
wav_folder_path = os.path.join(current_folder, "WAV")
...
def play_sound_for_event(first_word):
    ...
    if first_word in sound_mapping:
        sound_path = os.path.join(wav_folder_path, sound_mapping[first_word])
...
# 수정필요
# 시나리오 위치 : https://leanny.github.io/eggstra_work/coop_event_05.html
